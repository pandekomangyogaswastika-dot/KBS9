...
export default function SEOHead({
  ...
  const BASE_URL = "https://kbs-mapping-setup.preview.emergentagent.com";
...
export const createOrganizationSchema = () => ({
  ...
  alternateName: "KTI",
  url: "https://kbs-mapping-setup.preview.emergentagent.com",
  logo: "https://kbs-mapping-setup.preview.emergentagent.com/logo.png",
...
export const createWebsiteSchema = () => ({
  ...
  potentialAction: {
    ...
    target: {
      "@type": "EntryPoint",
      urlTemplate: "https://kbs-mapping-setup.preview.emergentagent.com/search?q={search_term_string}",
    },
...
export const createArticleSchema = (article) => ({
  ...
  image: article.image || "https://kbs-mapping-setup.preview.emergentagent.com/og-image.png",
  ...
  publisher: {
    ...
    logo: {
      "@type": "ImageObject",
      url: "https://kbs-mapping-setup.preview.emergentagent.com/logo.png",
    },
  },
});
