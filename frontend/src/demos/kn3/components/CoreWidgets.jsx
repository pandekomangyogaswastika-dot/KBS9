      ...
      <aside data-testid="app-sidebar" className={`app-sidebar ${open ? "open" : ""} no-print`}>
        <div className="sidebar-brand">
          ...
          <div className="sidebar-brand-text">
            <span data-testid="app-brand" className="t1">Smart WMS</span>
...
export function LoginScreen({ onLogin, notice }) {
  const [email, setEmail] = useState("admin@demo.wms");
  const [password, setPassword] = useState("demo12345");
  const demoUsers = [
    ["Admin", "admin@demo.wms"],
    ["Sales", "sales@demo.wms"],
    ["Manager", "manager@demo.wms"],
    ["Warehouse", "warehouse@demo.wms"],
  ];
  return (
    <main data-testid="login-screen" className="app-shell login-screen">
      <section className="login-card">
        <div className="login-left">
          ...
          <h1 data-testid="login-title" className="login-title">Smart WMS Platform</h1>
